...
func InsertInspectionTable(db *sql.DB, form models.InspectionForm) {
	...
	_, err := db.Exec(query,
		...
		form.Automatic_Drain_Valve_In_Place,
		...
		form.Transfer_Of_Power_To_Alternative_Power_Source_Verified,
		form.Power_Failure_Condition_Removed,
